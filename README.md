...
│   ├── init_db.py                 # Legacy SQLite layer (unused)
...
- **`init_db.py` is legacy.** Don't treat this file as the source of truth for the database schema — the actual schema lives in `database/migrations/`.
